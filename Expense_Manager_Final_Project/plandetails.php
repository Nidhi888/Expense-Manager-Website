                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <input type="date" class="form-control sample_class" id="from" name="from" min="2019-04-01" max="2021-05-18" required="true">

                                        </div>
                                        <div class="col-xs-6">
                                            <label for="to">To</label>
                                            <input type="date" class="form-control sample_class" id="to" name="to" min="2019-04-01" max="2021-05-18"required="true" >
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
